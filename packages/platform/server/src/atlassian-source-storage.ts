...
import type { AtlassianSourceStorage } from "@executor/plugin-atlassian-sdk";
import {
...
const decodeStoredSourceData = Schema.decodeUnknownSync(AtlassianStoredSourceDataSchema);
const encodeStoredSourceData = Schema.encodeSync(AtlassianStoredSourceDataSchema);
...
export const createFileAtlassianSourceStorage = (input: {
  rootDir: string;
}): AtlassianSourceStorage => ({
